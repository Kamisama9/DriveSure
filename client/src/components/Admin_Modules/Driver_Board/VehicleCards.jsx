...
const VehicleCards = ({ ownerId, onClose }) => {
	...
	const VehicleDetailModal = ({ vehicle, onClose }) => {
		...
		return (
			<div
				className="fixed inset-0 bg-black bg-opacity-60 flex items-start justify-center z-[60] p-4 py-8 overflow-y-auto no-scrollbar"
				onClick={onClose}
			>
				<div
							...
							<div className="grid grid-cols-3 gap-4">
									...
									<div className="text-center">
										<div
											className={`w-12 h-12 mx-auto rounded-full flex items-center justify-center mb-3 ${
												vehicle.is_rc_verified ? "bg-green-500" : "bg-red-500"
											}`}
										>
											{vehicle.is_rc_verified ? (
												<svg
								...
								>
									<div className="text-center">
										<div
											className={`w-12 h-12 mx-auto rounded-full flex items-center justify-center mb-3 ${
												vehicle.is_puc_verified ? "bg-green-500" : "bg-red-500"
											}`}
										>
											{vehicle.is_puc_verified ? (
												<svg
							...
							<div className="bg-gray-50 rounded-lg p-5">
								...
								<div className="space-y-3">
									...
									<div className="flex justify-between items-center py-2 border-b border-gray-200">
										...
										<span className="font-mono font-semibold text-gray-900 bg-white px-2 py-1 rounded text-sm">
											{vehicle.rc_number}
										</span>
									</div>
