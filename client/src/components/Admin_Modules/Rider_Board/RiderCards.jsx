        ...
        <div className="p-8 bg-gradient-to-r from-blue-50 to-indigo-50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="group bg-gradient-to-br from-gray-50 to-gray-100 p-4 rounded-xl border border-gray-200 hover:shadow-md transition-all duration-200 hover:border-gray-300">
              ...
              <div className="text-gray-900 font-medium text-base">{rider.email}</div>
            </div>
            ...
            <div className="group bg-gradient-to-br from-gray-50 to-gray-100 p-4 rounded-xl border border-gray-200 hover:shadow-md transition-all duration-200 hover:border-gray-300">
              ...
              <div className="text-gray-900 font-medium text-base">{rider.first_name}</div>
            </div>
            ...
            <div className="group bg-gradient-to-br from-gray-50 to-gray-100 p-4 rounded-xl border border-gray-200 hover:shadow-md transition-all duration-200 hover:border-gray-300">
              ...
              <div className="text-gray-900 font-medium text-base">{rider.last_name}</div>
            </div>
            ...
            <div className="group bg-gradient-to-br from-gray-50 to-gray-100 p-4 rounded-xl border border-gray-200 hover:shadow-md transition-all duration-200 hover:border-gray-300">
              ...
              <div className="text-gray-900 font-medium text-base">{rider.middle_name || "—"}</div>
            </div>
            ...
            <div className="group bg-gradient-to-br from-indigo-50 to-indigo-100 p-4 rounded-xl border border-indigo-200 hover:shadow-md transition-all duration-200 hover:border-indigo-300">
              <label className="block text-xs font-semibold text-indigo-600 uppercase tracking-wide mb-2 group-hover:text-indigo-700">Email Verified</label>
              <div className="text-gray-900 font-medium text-base">
                <span className={`inline-flex items-center px-3 py-1.5 rounded-full text-sm font-semibold ${formData.is_email_verified ? 'bg-green-100 text-green-800 border border-green-200' : 'bg-red-100 text-red-800 border border-red-200'
                  }`}>
            ...
            <div className="group bg-gradient-to-br from-indigo-50 to-indigo-100 p-4 rounded-xl border border-indigo-200 hover:shadow-md transition-all duration-200 hover:border-indigo-300">
              <label className="block text-xs font-semibold text-indigo-600 uppercase tracking-wide mb-2 group-hover:text-indigo-700">Phone Verified</label>
              <div className="text-gray-900 font-medium text-base">
                <span className={`inline-flex items-center px-3 py-1.5 rounded-full text-sm font-semibold ${formData.is_phone_verified ? 'bg-green-100 text-green-800 border border-green-200' : 'bg-red-100 text-red-800 border border-red-200'
                  }`}>
            ...
            <div className="group bg-gradient-to-br from-gray-50 to-gray-100 p-4 rounded-xl border border-gray-200 hover:shadow-md transition-all duration-200 hover:border-gray-300">
              <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2 group-hover:text-gray-600">Created At</label>
              <div className="text-gray-900 font-medium text-base flex items-center">
                <span className="inline-flex items-center">
            ...
            <div className="group bg-gradient-to-br from-gray-50 to-gray-100 p-4 rounded-xl border border-gray-200 hover:shadow-md transition-all duration-200 hover:border-gray-300">
              <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2 group-hover:text-gray-600">Updated At</label>
              <div className="text-gray-900 font-medium text-base flex items-center">
                <span className="inline-flex items-center">
