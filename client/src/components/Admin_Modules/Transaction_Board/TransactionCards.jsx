        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-4">
              <span className="text-lg font-medium text-gray-600">Booking ID: {transaction.id}</span>
              <span className={`px-3 py-1 rounded-full text-sm font-medium ${getStatusBadge(transaction.booking_status)}`}>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <div className="text-xs text-gray-500 mt-1">
                    Coordinates: {transaction.pickup_lat}, {transaction.pickup_lng}
                  </div>
                </div>
            ...
            <div className="bg-green-50 p-4 rounded-lg">
              ...
              <div className="space-y-3">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-600 mb-1">Fare Amount</label>
                  ...
                  <div>
                    ...
                    <div className="bg-white p-2 rounded">
                      <span className={`px-3 py-1 rounded-full text-sm font-medium ${getPaymentBadge(transaction.payment_status)}`}>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-1">Rate per KM</label>
                  <div className="text-gray-900 text-sm bg-white p-2 rounded">
                    ₹{transaction.distance_km > 0 ? (transaction.fare / transaction.distance_km).toFixed(2) : '0.00'}/km
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-purple-50 p-4 rounded-lg">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Rider Information</h3>
              <div className="space-y-3">
                <div>
            ...
            <div className="bg-orange-50 p-4 rounded-lg">
              ...
              <div className="space-y-3">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-1">Driver ID</label>
                  <div className="text-gray-900 text-xs bg-white p-2 rounded font-mono">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="space-y-3">
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-1">Booking Created</label>
                  <div className="text-gray-900 text-sm bg-white p-2 rounded">
