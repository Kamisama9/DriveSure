        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 max-w-4xl mx-auto text-sm text-gray-500">
            ...
            >
              ...
              <span className="group-hover:text-purple-700 transition-colors duration-300">Rider Board</span>
            </div>
            ...
            >
              ...
              <span className="group-hover:text-orange-700 transition-colors duration-300">Driver Board</span>
            </div>
            ...
            >
              ...
              <span className="group-hover:text-green-700 transition-colors duration-300">Fare Board</span>
            </div>
            ...
            >
              ...
              <span className="group-hover:text-blue-700 transition-colors duration-300">Transactions</span>
            </div>
            ...
            >
              ...
              <span className="group-hover:text-indigo-700 transition-colors duration-300">Verifications</span>
            </div>
          </div>
